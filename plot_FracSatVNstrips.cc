////////////
//
//      try to draw Fraction of satuarted strips  histogram from ntuple as monoNtupleAnalyzer.cc
//      2020 6/14 
//
#include "iostream"
...
void plot_FracSatVNstrips()
{
	...
	TCanvas *canvas = new TCanvas("canvas","canvas",400, 600);
...
//		cand[0].print();
		...
		//cut
		if(cand[0].dist_<0.5&&cand[0].hIso_<10&&cand[0].xyp0_<0.6&&cand[0].xyp2_>1000){
		//why xyp2>1000 not <1000
