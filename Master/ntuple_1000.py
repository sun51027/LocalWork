...
'file:/eos/cms/store/user/srimanob/monopole/13TeV/Legacy-RECO/2018-3000/RECO_2018_3000_1.root'
)
,
...
#from PhysicsTools.PatAlgos.python.slimming.selectedPatTrigger_cfi import patTrigger
...
process.Monopoler = cms.EDAnalyzer('MonoNtupleDumper'
  ...
  ,Output = cms.string("MonopoleNtuple_2018_3000.root")
