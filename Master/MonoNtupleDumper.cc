...
// March 2021: Shih Lin : add new HLT path
...
private:
  ...
  bool passHLT_PFMET200_HBHE_BeamHaloCleaned_;//2017 2018
  bool passHLT_PFMET250_HBHECleaned_;// 2017 2018
  bool passHLT_PFMET300_HBHECleaned_;//2017 2018
  bool passHLT_PFMETTypeOne200_HBHE_BeamHaloCleaned_;//2017 2018
  bool passHLT_CaloMET250_NotCleaned_;
  bool passHLT_CaloMET250_HBHECleaned_;
  bool passHLT_CaloMET300_HBHECleaned_;
  bool passHLT_CaloMET350_HBHECleaned_;
  //bool passHLT_Photon165_HE10_ ;
...
void MonoNtupleDumper::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  passHLT_CaloMET250_NotCleaned_ = 0;
  passHLT_CaloMET250_HBHECleaned_ = 0;
  passHLT_CaloMET300_HBHECleaned_ = 0;
  passHLT_CaloMET350_HBHECleaned_ = 0;
  //passHLT_Photon165_HE10_ = 0;
  ...
  for( auto obj : *_triggerobjhandle ){
    ...
    if (passHLT_Photon175_)


    bool matchresult = TrigObjMatchPathFilter( obj, hltpair.first, hltpair.second );
  ...
  cout<< "HLT_PFMET200_NotCleaned = " <<passHLT_PFMET200_NotCleaned_<<endl;
  cout<< "HLT_PFMET200_HBHECleaned = " <<passHLT_PFMET200_HBHECleaned_<<endl;
  ...
  cout<< "HLT_CaloMET250_NotCleaned = " <<passHLT_CaloMET250_NotCleaned_<<endl;
  cout<< "HLT_CaloMET250_HBHECleaned = " <<passHLT_CaloMET250_HBHECleaned_<<endl;
  cout<< "HLT_CaloMET300_HBHECleaned = " <<passHLT_CaloMET300_HBHECleaned_<<endl;
  cout<< "HLT_CaloMET350_HBHECleaned = " <<passHLT_CaloMET350_HBHECleaned_<<endl;
#endif
  ...
  */
  ...
  std::cout<<"Pass: Jet collection"<<std::endl;
  ...
  std::cout<<"Pass: Photon collection"<<std::endl;
  m_pho_N = nPhotons;
  ...
  m_ele_N = nElectrons;
   ...
   std::cout<<"Pass: electron collection"<<std::endl;
  ...
  if (!m_isData){
	...
	if(particle->pdg_id() > 0){
     ...
     std::cout<<"Pass: genMono collection"<<std::endl;
  //////////////////////////////////////////////////////////
...
MonoNtupleDumper::beginJob()
{
  ...
  m_tree->Branch("passHLT_CaloMET250_NotCleaned" , &passHLT_CaloMET250_NotCleaned_ , "passHLT_CaloMET250_NotCleaned/O");
  m_tree->Branch("passHLT_CaloMET250_HBHECleaned" , &passHLT_CaloMET250_HBHECleaned_ , "passHLT_CaloMET250_HBHECleaned/O");
  ...
  //m_tree->Branch("passHLT_Photon165_HE10" , &passHLT_Photon165_HE10_ , "passHLT_Photon165_HE10/O");
...
bool
MonoNtupleDumper::TrigObjMatchPathFilter(
...
string
MonoNtupleDumper::GlobToRegex( const std::string& query )
{
