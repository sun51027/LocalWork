...
//		TFile *fin_3 = new TFile (("Monopole_Analyzer_"+Year[y]+"_3000.root").c_str());
		...
		TFile *fin_1 = new TFile (("Monopole_Analyzer_test_"+Year[y]+"_1000.root").c_str());
		TFile *fin_2 = new TFile (("Monopole_Analyzer_test_"+Year[y]+"_2000.root").c_str());
		TFile *fin_3 = new TFile (("Monopole_Analyzer_test_"+Year[y]+"_3000.root").c_str());
//		TDirectory *dir_1 = (TDirectory*)fin_1->Get("NO TRG");
//		TDirectory *dir_2 = (TDirectory*)fin_2->Get("NO TRG");
//		TDirectory *dir_3 = (TDirectory*)fin_3->Get("NO TRG");
...
//        leg->AddEntry(DedXSig[i],Mass[m].c_str(),"f");
        ...
        leg->Draw();
        canvas->SaveAs(("./Plots/TRG/"+Year[y]+" "+plotName[i]+"DedXSig_eta.pdf").c_str());
        //canvas->SaveAs(("./Plots/NoTRG/"+Year[y]+" "+plotName[i]+"DedXSig_eta.pdf").c_str());
       // canvas->SaveAs(("./Plots/NoTRG/"+Year[y]+" "+plotName[i]+"DedXSig.pdf").c_str());
...
/*	F511.push_back((TH1D*)dir_1->Get((histogram[i]+"F51").c_str()));
	...
	F513.push_back((TH1D*)dir_3->Get((histogram[i]+"F51").c_str()));
        ...
        leg2->Draw();
        canvas->SaveAs(("./Plots/NoTRG/"+Year[y]+" "+plotName[i]+"f51.pdf").c_str());
	...
	HcalIso3.push_back((TH1D*)dir_3->Get((histogram[i]+"HcalIso").c_str()));
        ...
        leg3->Draw();
        canvas->SaveAs(("./Plots/NoTRG/"+Year[y]+" "+plotName[i]+"HcalIso.pdf").c_str());
	...
	//Energy(e55)
        ...
        leg4->Draw();
        canvas->SaveAs(("./Plots/NoTRG/"+Year[y]+" "+plotName[i]+"Energy.pdf").c_str());
	...
	RZcurv3.push_back((TH1D*)dir_3->Get((histogram[i]+"RZcurv").c_str()));
        ...
        leg5->Draw();
        canvas->SaveAs(("./Plots/NoTRG/"+Year[y]+" "+plotName[i]+"RZcurv.pdf").c_str());
